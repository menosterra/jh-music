...
audioPlayer.addEventListener('error', (e) => {
    console.error("Audio playback error:", audioPlayer.error, "URL:", audioPlayer.src);
    if (titleEl && currentPlaylist[currentIndex]) {
        titleEl.textContent = `${currentPlaylist[currentIndex].name} (Error loading audio)`;
    }
});

audioPlayer.addEventListener('playing', () => {
    if (titleEl && currentPlaylist[currentIndex]) {
        titleEl.textContent = currentPlaylist[currentIndex].name;
    }
});
